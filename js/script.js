...
ScrollReveal().reveal('.home-img, .servico-container, .portfolio-box, contato form', { origin: 'bottom' });
...
const typed = new Typed('.multiple-text', {
    strings: ['Developer Frontend', 'Técnico em Marketing', 'Designer Gráfico'],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
